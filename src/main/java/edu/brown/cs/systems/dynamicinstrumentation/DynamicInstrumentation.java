...
public class DynamicInstrumentation {
    ...
    // LoggerFactory.getLogger(DynamicInstrumentation.class);
    ...
    /**
     * From
     * https://github.com/philz/stethoscope/blob/master/src/main/java/org/cloudera/stethoscope/Util.java
     */
    ...
    /**
     * Creates and returns a dynamic instrumentation agent. If useJdwp is set to
     * true, this method first tries to
     * attach to the process using JDWP. If useJdwp is set to false, this method
     * first tries to attach a java
     * instrumentation agent to the process. If the preferred method fails, the
     * other method is attempted. If both
     * methods fail, returns null.
     * 
     * @param preferJdwp Prefer JDWP based instrumentation to java instrumentation
     *                   agent
