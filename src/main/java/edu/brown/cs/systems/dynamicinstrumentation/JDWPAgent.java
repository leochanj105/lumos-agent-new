...
// /** Does class reloading, modification, and hotswapping using Javassist's
// HotSwapper, which uses JDWP to reload classes.
...
// LoggerFactory.getLogger(JDWPAgent.class);
...
// public static synchronized JDWPAgent get() throws IOException,
...
// System.err.println("Could not acquire JDWP address to attach dynamic
// instrumentation. "
// + "Ensure JVM runs with argument
...
// public JDWPAgent(String port) throws IOException,
// IllegalConnectorArgumentsException {
