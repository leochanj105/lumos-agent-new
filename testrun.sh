...
$JAVA_HOME/bin/java -Dverbose=analysis -DDev=true -DConcurrencyInst=/home/jingyuan/doopstuff/doop/lfacts/deps/nn/ConcurrencyNondRecord.csv -jar target/LumosAgent.jar
